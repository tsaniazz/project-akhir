                                ...
                                <form class="user">
                                    ...
                                    <div class="form-group" for="email">
                                        <input id="email" type="email"
                                            ...
                                            value="{{ old('email') }}" required autocomplete="email" placeholder="Masukkan Email Anda !">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-6 mb-3 mb-sm-0" for="pssword">
                                            <input id="password" type="password"
                                                class="form-control @error('password') is-invalid @enderror"
                                                name="password" required autocomplete="new-password" placeholder="Masukkan Password Anda !">
                                        ...
                                        <div class="col-sm-6" for="password-confirm">
